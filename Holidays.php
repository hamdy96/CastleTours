...
<html lang="en">
  <head>
    <title> CastleTours | Holidays </title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    <?php require_once './StickButton.html'; ?>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0"><a href="index.php" class="text-black h2 mb-0"><img style="width: 80%;"src="images/logo.jpg"></a></h1>
          </div>
          <div class="col-10 col-md-8 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li><a href="Honeymooners.php">Honeymooners</a></li>
          ...
          <div class="col-6 col-xl-2 text-right">
            <div class="d-none d-xl-inline-block">
              <ul class="site-menu js-clone-nav ml-auto list-unstyled d-flex text-right mb-0" data-class="social">
                <li>
                  <input type="image" style="width: 10%;" src="images/uae-icon.png" name="uae-icon">
                  <a href="http://google.com" class="button"> Castle Tours UAE</a>
                </li>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              <h1 class="text-white font-weight-light">Discover Our Holidays</h1>
              <div><a href="index.php">Home</a> <span class="mx-2 text-white">&bullet;</span> <span class="text-white">Holidays</span></div>
        ...
        <div class="row">
          <div class="col-md-2 col-lg-2 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="images/country.jpg" alt="Image" class="img-fluid">
              <div class="unit-1-text">
                <h3 class="unit-1-heading" >Africa</h3>
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-2 mb-2 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="images/country.jpg" alt="Image" class="img-fluid">
              <div class="unit-1-text">
                <h3 class="unit-1-heading" >Europe</h3>
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-2 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="images/country.jpg" alt="Image" class="img-fluid">
              <div class="unit-1-text">
                <h3 class="unit-1-heading">Middle East</h3>
              </div>
            </a>
          </div>
        </div>
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              <h3 class="footer-heading mb-4">About Castle Tours</h3>
              <p>Established in the year 2000, Managed by Mr.Sayed Abdel Ghany, Our company handling all tourism operations all over the country, specializes in inbound tours, ticketing ,transportation, hotels booking, conference organization, diving, safari, airport meet and assist.</p>
            </div>
